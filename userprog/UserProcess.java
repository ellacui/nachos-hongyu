...
public class UserProcess {
     ...
     */
    public UserProcess() {
        int numVirtualPages = 256;

        // Whole memory size / compressed memory size
        int compressedMemRatio = 2;
        // Number of pages to compress together
        int compressBlockSize = 8;

        int numPhysPages = Machine.processor().getNumPhysPages();

        // Create an empty page table. Number of entry = numVirtualPages
        // pageTable = new TranslationEntry[numVirtualPages];
        // for (int i = 0; i < numVirtualPages; i++)
        // pageTable[i] = new TranslationEntry(i, -1, false, false, false, false, false, -1, null);
    }
    ...
    public void handleException(int cause) {
        ...
        case Processor.exceptionPageFault:
            // (TODO) handle page fault exception
            // swap
            System.out.println("********* page fault expection ******");
            break;
        default:
